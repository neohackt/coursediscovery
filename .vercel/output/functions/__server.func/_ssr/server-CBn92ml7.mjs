...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-Cu5rJjD2.mjs");
...
const manifest = {
  "4a40a4129642fc7792a1a069bfd74efbf13250e0bf9200d206c3a557e6620867": {
    functionName: "fetchAllPosts_createServerFn_handler",
    importer: () => import("./blog.functions-C-p5LjQ7.mjs")
  },
  "82d290afec4528618ab5960b7dcf266cae46963e01cf4fd78e5b87136a64dcf6": {
    functionName: "fetchPostBySlug_createServerFn_handler",
    importer: () => import("./blog.functions-C-p5LjQ7.mjs")
  },
  "6fe04a38603cac8edd0e230e075b9f2bccf9b1db55b1563abee3182b76979e7f": {
    functionName: "fetchAllCourses_createServerFn_handler",
    importer: () => import("./courses.functions-BruhkwL5.mjs")
  },
  "18a603b1364d74e7bfdeacb6c04f726f6d6757c2342b9aaf1c18416d8340f04c": {
    functionName: "fetchFeaturedCourses_createServerFn_handler",
    importer: () => import("./courses.functions-BruhkwL5.mjs")
  },
  "973ad4ea538ab076ac0674ea208b3d05781bb8e5c4d6008b078d98fbdd13dd28": {
    functionName: "fetchCoursesByCategory_createServerFn_handler",
    importer: () => import("./courses.functions-BruhkwL5.mjs")
  },
  "8061c5dfc0c6bddc3757759be3d0974415958ac1659a8dd63c4656c959bf2f04": {
    functionName: "fetchCoursesGroupedByCategory_createServerFn_handler",
    importer: () => import("./courses.functions-BruhkwL5.mjs")
  }
};
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-4VIZ9_6n.mjs").then((n) => n.r),
